...
const P = {
  ...
  layer: <><path d="m12 4.5 8.2 4.2L12 13 3.8 8.7Z" /><path d="m3.8 12.8 8.2 4.3 8.2-4.3M3.8 16.9 12 21.2l8.2-4.3" /></>,
  drop: <path d="M12 3.6C8.8 7.8 6.2 11.2 6.2 14.8a5.8 5.8 0 0 0 11.6 0c0-3.6-2.6-7-5.8-11.2Z" />,
  eye: <><path d="M2.5 12c2.5-5 5.5-8 9.5-8s7 3 9.5 8c-2.5 5-5.5 8-9.5 8s-7-3-9.5-8Z" /><circle cx="12" cy="12" r="3.2" /></>,
  eyeSlash: <><path d="m3.5 3.5 17 17M10.6 10.6a3.2 3.2 0 0 0 4.2 4.2M7.2 7.5C4.8 9 3.2 11 2.5 12c2.5 5 5.5 8 9.5 8 2.2 0 4.2-.9 5.9-2.2M10.2 4.1c.6-.1 1.2-.1 1.8-.1 4 0 7 3 9.5 8-.7 1.4-1.7 2.7-2.9 3.8" /></>,
